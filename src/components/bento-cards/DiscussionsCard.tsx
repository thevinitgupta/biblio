...
export default function DiscussionsCard() {
    return (
        ...
        >
          ...
          <div className="absolute z-40 w-48 h-48 bg-gradient-to-t from-slate-50 via-slate-100 to-slate-200 blur-2xl rounded-full right-6 top-0 hidden md:block"></div>
          ...
          <img
            src={"/post_tile.png"}
            alt=""
            className="h-auto md:h-[75%] w-5/6 md:w-auto relative object-contain z-[30] rounded-2xl shadow-2xl shadow-amber-600/45"
            />
            </div> 

            <div className="relative w-full flex flex-col items-center justify-center space-y-2 z-50">
              <p className="w-full text-sm sm:text-base md:text-xl text-left text-[#021127ff] font-poppins p-4 ml-4">
