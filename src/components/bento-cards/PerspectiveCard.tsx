...
export default function PerspectiveCard() {
    return (
        ...
        >
            ...
            <div className="absolute z-20 w-48 h-56 bg-gradient-to-t from-yellow-700/80 to-amber-600/70 blur-2xl opacity-60 rounded-full top-10 left-10"></div>
            <div className="absolute z-10 w-48 h-56 bg-gradient-to-t from-red-400/80 to-red-600/80 blur-2xl opacity-60 rounded-full top-10 right-10"></div>
            <div className="absolute z-20 w-72 h-72 bg-gradient-to-t from-cyan-700/80 to-blue-600/80 blur-2xl opacity-60 rounded-full top-4 left-[30%]"></div>
                ...
                <div className="w-[90%] h-[75%] flex justify-center items-center z-50">
                    {/* Image 1 */}
                    <div className="h-full max-h-[200px] flex justify-center items-center relative z-30 rounded-2xl overflow-hidden rotate-y-20">
                        <img
                            src={"/book_yellow.png"}
                            alt=""
                    ...
                    {/* Image 3  */}
                    <div className="h-full max-h-[200px] flex justify-center items-center relative rounded-2xl overflow-hidden z-30  -rotate-y-20">
                        <img
                            src={"/book_red.png"}
                            alt=""
                            className="h-full relative object-cover"
                ...
                <div className="relative w-full flex flex-col items-center justify-center space-y-2 z-50">
                    <p className="w-full text-xl text-left text-[#fffcff]/80 font-poppins p-4 ml-4">
