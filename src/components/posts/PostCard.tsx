        ...
        <div className="card min-h-28 w-full bg-base-100 max-w-[85vw] md:max-w-[35vw] lg:max-w-[28vw] shadow-inner shadow-slate-700">
            <div className="card-body">
                ...
                <div className="card-actions justify-end mt-5">
                    <button className="btn bg-accent hover:bg-base-200 text-accent-content hover:text-primary border border-accent hover:border-accent" onClick={handleViewPost}>View Post</button>
                </div>
            </div>
        </div>
    )
