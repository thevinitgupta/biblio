...
const useUploadPostImage = () => {
  ...
  return useMutation({
    ...
    mutationFn: async (values: any) => {
      ...
      const uploadPostImageResponse: AxiosResponse =
        await fileUploadClient.post("/posts/image", formData, {
          headers: headers,
        });
      ...
      const createPostResponseData: PostImageUploadResponse =
        (uploadProfileImageResponseData as PostImageUploadResponse) || "";

      return {
        data: createPostResponseData.postImage,
